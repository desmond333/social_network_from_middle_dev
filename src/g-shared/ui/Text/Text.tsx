...
export const H1: FC<TextUIProps> = ({
    color, children, align, id,
}) => (
    <Text
        variant="h1"
        color={color}
...
export const H2: FC<TextUIProps> = ({
    color, children, align, id,
}) => (
...
export const H3: FC<TextUIProps> = ({
    color, children, align, id,
}) => (
...
export const H4: FC<TextUIProps> = ({
    color, children, align, id,
}) => (
...
export const H5: FC<TextIProps> = ({
    color, children, align, tag,
}) => (
